...
class ReceiptScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<String>(
      future: CounterService.getAndUpdateCounter(), // Call the method from CounterService
      builder: (context, snapshot) {
        ...
        String counter = snapshot.data ?? '000001'; // Get the formatted counter value
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      'Sale Invoice #: SP${DateTime.now().year}$counter', // Use dynamic counter here
